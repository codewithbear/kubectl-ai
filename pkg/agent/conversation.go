...
", s)))
  ...
  3) No`
				...
				normalizedChoice := normalizeConfirmationChoice(selectedChoice)
...
// normalizeConfirmationChoice maps various user inputs to "1", "2", or "3" as appropriate.
func normalizeConfirmationChoice(choice string) string {
